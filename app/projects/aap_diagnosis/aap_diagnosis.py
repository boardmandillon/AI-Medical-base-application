...
class AAPDiagnosis:
    ...
    def model_accuracy():
        ...
        if not data:
            print("No test data found for the model")
            return None
        else:

            print("Calculating accuracy score of dataset...")
            # # # # # # # # # # # # METHOD 1 # # # # # # # # # # # # # # # # # # # # # # 
            ...
            print("Method 1:")
            print("Accuracy score of dataset: ", score)
            ...
            if(data['te_t_diagnosis'][0]!=None):
                ...
                print("Method 2:")
                print("Accuracy score of dataset: ", second_score)
            else:
                print("Method 2 for calculating accuracy unable to run as no test predictions.")
                print("Run celery task 'aap_diagnosis_train' first.")
...
def test_classifier():
    ...
    if not data:
        ...
        print("Validating model using test data...")
        ...
        print("Model validated using test data.")
